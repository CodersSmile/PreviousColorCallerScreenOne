...
-keep class com.mobile_location.sdk.caller.location.tracker.adsManage.** {*;}
...
-keep public class com.gbwhatapptool.randomgboff.gbwhatsnewversion.api.Example.packages.model.** {*;}
...
-keep class * implements com.google.gson.JsonSerializer
-keep class * implements com.google.gson.JsonDeserializer
#---------------------------------------------------------------------------------------------------MyGson (custom packages with @SerializedName and Retrofit interface)
-keep class com.themescreen.flashcolor.stylescreen.admobmanager.** {*;}
-keep class com.themescreen.flashcolor.stylescreen.Activity.Theme_Activity_Splash_screen
#---------------------------------------------------------------------------------------------------// Hash Map error Solverd //
