...
public class SharePreferencess {
        ...
        public void setAd_show_Admob(String ad_show_admob) {
            preferences.edit().putString("ad_ADshow", ad_show_admob).apply();
        }

        public String getAd_show_Admob() {
            return preferences.getString("ad_ADshow", "");
        }
        ...
        public void setAppDialogShowBefore(int appDialogShowBefore)
        {
         preferences.edit().putInt("dialogshow",appDialogShowBefore).apply();
        }
        public int getAppDialogShowBefore()
        {
           return preferences.getInt("dialogshow",0);
        }
        public void setCountTimer(int timer)
        {
            preferences.edit().putInt("deleycount",timer).apply();
        }
        public int getCountTimer()
        {
           return preferences.getInt("deleycount",0);
        }

        public void setPlatForm(String platForm)
        {
          preferences.edit().putString("platfram",platForm).apply();
        }
        public String getPlatFrom()
        {
            return preferences.getString("platfram","");
        }
    }
