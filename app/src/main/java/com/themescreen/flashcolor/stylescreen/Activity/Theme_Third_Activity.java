...
public class Theme_Third_Activity extends AppCompatActivity {
    TextView start_btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        start_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Appmanage.getInstance(Theme_Third_Activity.this).show_INTERSTIAL(Theme_Third_Activity.this, new Appmanage.MyCallback() {
                    @Override
                    public void callbackCall() {
                        if(sp.getScreenFlag()==3)
                        {
                            startActivity(new Intent(getApplicationContext(), Theme_LetsStartActivity.class));
                        }
                        else
                        {
                            startActivity(new Intent(getApplicationContext(), Theme_Forth_Activity.class));
                        }
                    }
    ...
    public void onBackPressed() {
        Appmanage.getInstance(Theme_Third_Activity.this).show_INTERSTIAL(Theme_Third_Activity.this, new Appmanage.MyCallback() {
            @Override
            public void callbackCall() {
                Theme_Third_Activity.super.onBackPressed();
            }
