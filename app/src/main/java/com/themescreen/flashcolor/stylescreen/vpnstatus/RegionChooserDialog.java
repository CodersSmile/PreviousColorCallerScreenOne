package com.themescreen.flashcolor.stylescreen.vpnstatus;
...
public class RegionChooserDialog extends DialogFragment implements CountryAdapter.selecTionCountry, View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        init(mainView);
        Ad_mob_Manager.showBanner(getContext(), mainView.findViewById(R.id.ad_banner), getActivity().getWindow() );
        this.view = mainView;
        return mainView;
    }
    ...
    private void loadServer() {
        ...
        UnifiedSDK.getInstance().getBackend().countries(new com.anchorfree.vpnsdk.callbacks.Callback<AvailableCountries>() {
            ...
            public void success(@NonNull final AvailableCountries countries) {
                ...
                Utils.list = countries.getCountries();
                for (Country country : Utils.list) {
                    for (Country_Code counteyModal : Utils.list_Country) {
