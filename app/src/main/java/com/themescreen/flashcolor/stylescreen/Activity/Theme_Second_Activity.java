...
public class Theme_Second_Activity extends AppCompatActivity {
    TextView start_btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        start_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Appmanage.getInstance(Theme_Second_Activity.this).show_INTERSTIAL(Theme_Second_Activity.this, new Appmanage.MyCallback() {
                    @Override
                    public void callbackCall() {
                        if(sp.getScreenFlag()==2)
                        {
                            startActivity(new Intent(getApplicationContext(), Theme_LetsStartActivity.class));
                        }
                        else
                        {
                            startActivity(new Intent(getApplicationContext(), Theme_Third_Activity.class));
                        }
                    }
    ...
    public void onBackPressed() {
        Appmanage.getInstance(Theme_Second_Activity.this).show_INTERSTIAL(Theme_Second_Activity.this, new Appmanage.MyCallback() {
            @Override
            public void callbackCall() {
                Theme_Second_Activity.super.onBackPressed();
            }
